  ...
  const renderCompanySelection = () => (
    <div className="animate-fadeIn">
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold mb-2 text-slate-900">בחירת חברות ביטוח</h2>
  ...
  const renderCommissionAgreements = () => (
    <div className="animate-fadeIn space-y-5">
      <div className="text-center mb-5">
        ...
        <p className="text-slate-500 text-sm">מלא את נתוני העמלות עבור כל חברה שבחרת. ניתן להשאיר שדות ריקים.</p>
      </div>
      ...
      {profile.selectedCompanies.length === 0 ? (
        ...
        profile.selectedCompanies.map(company => (
          <div key={company} className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm">
